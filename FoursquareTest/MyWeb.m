...
+(void)downloadImageSync:(NSString*)urlStr completionHandler:(void (^)(NSData *retData))handler
{
...
{	
    ...
    if(responseData)
    {
        ...
        jsonData = [NSJSONSerialization JSONObjectWithData:responseData options:NSJSONReadingMutableContainers error:nil];
